...
import com.example.androiddevelopment.slobodangolocorbin.dialog.AboutDialog;
import com.example.androiddevelopment.slobodangolocorbin.preferences.Prefererences;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
                ...
                add.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            if (toast){
                                Toast.makeText(FirstActivity.this, "Dodata nova prijava", Toast.LENGTH_SHORT).show();
                            }
            ...
            case R.id.preferences:
                startActivity(new Intent(FirstActivity.this, Prefererences.class));
                break;
        }
